...
func Generate(columnTypes map[string]map[string]string, sortKeys []string, tableName string, structName string, pkgName string, jsonAnnotation bool, gormAnnotation bool, gureguTypes bool) ([]byte, error) {
	var dbTypes string
	dbTypes = generateMysqlTypes(columnTypes, sortKeys, 0, jsonAnnotation, gormAnnotation, gureguTypes)
